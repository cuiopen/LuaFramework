...
--测试协同--
function LoginScene.test_coroutine()    
    logWarn("1111");
    coroutine.wait(1);	
    logWarn("2222");
...
--测试sproto--
function LoginScene.test_sproto_func()
...
--测试lpeg--
function LoginScene.test_lpeg_func()
...
--测试lua类--
function LoginScene.test_class_func()
    LuaClass:New(10, 20):test();
end

--测试pblua--
function LoginScene.test_pblua_func()
...
--pblua callback--
function LoginScene.OnPbluaCall(data)
...
--测试pbc--
function LoginScene.test_pbc_func()
...
--pbc callback--
function LoginScene.OnPbcCall(data)
    local path = Util.DataPath.."lua/3rd/pbc/addressbook.pb";
...
--测试cjson--
function LoginScene.test_cjson_func()
...
--cjson callback--
function LoginScene.OnJsonCall(data)
